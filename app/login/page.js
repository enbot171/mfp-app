    ...
    <div className="min-h-screen bg-canvas flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-shell rounded-2xl mb-4 shadow-card">
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>
          <h1 className="text-2xl font-bold text-ink tracking-tight">MFP App</h1>
          <p className="text-base text-muted mt-1">Pledge &amp; Payment Processor</p>
        </div>

        {/* Card */}
        <div className="bg-surface rounded-2xl shadow-card border border-line p-8">
          <h2 className="text-md font-semibold text-ink">Welcome back</h2>
          <p className="text-base text-muted mt-1 mb-6">Enter your password to continue.</p>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-base font-medium text-ink mb-1.5">Password</label>
              <input
                type="password"
                value={password}
            ...
            {error && (
              <div className="flex items-center gap-2 p-3 bg-danger/8 border border-danger/15 rounded-xl">
